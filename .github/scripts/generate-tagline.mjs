...
function buildBadge(tag, dark)
{
  ...
  const primaryAccent = dark ? '#f5a524' : '#b45309';
  const primaryBorder = dark ? 'rgba(245,165,36,0.65)' : 'rgba(180,83,9,0.60)';
  const primaryBg = dark ? 'rgba(245,165,36,0.14)' : 'rgba(180,83,9,0.10)';
